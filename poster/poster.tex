		...
		\begin{column}{\twocolwid}
			...
			\begin{columns}[t,totalwidth=\twocolwid] % Split up the two columns wide column
				...
				\begin{column}{\onecolwid}\vspace{-.6in}
					...
					\begin{SCfigure}
						...
						\caption{Figure 1.1 - Pun Detection (Homographic)}
					\end{SCfigure}
					\\
					\vspace{20mm}
					\begin{SCfigure}
						\includegraphics[width=0.85\textwidth]{HeterographicDetection.png}\\
						\caption{Figure 1.2 - Pun Detection (Heterographic)}
					\end{SCfigure}
				\end{column}
				%----------------------------------------------------------------------------------------
			...
			\begin{columns}[t,totalwidth=\twocolwid]
				...
				\begin{column}{\onecolwid}
					...
					\caption{Figure 2.1 - Pun Location (Homographic)}
					\end{SCfigure}
					\\
					\vspace{20mm}
					\begin{SCfigure}
					\includegraphics[width=0.85\textwidth]{HeterographicLocation.png}\\
					\caption{Figure 2.2 - Pun Location (Heterographic)}
					\end{SCfigure}
				\end{column}
				%----------------------------------------------------------------------------------------
				% right column
