  ...
  \begin{columns}[t]												% the [t] option aligns the column's content at the top
    ...
    \begin{column}{\onecolwid}
      ...
      \begin{block}{Introduction}
        ...
        \vskip1ex
        \begin{itemize}
          \item {\textbf{Pun} : A pun is a form of wordplay in which a word\textquotesingle s multiple meanings or similar sounding words are used in a comedical manner. There are many different types of puns.}
           \item {\textbf{Homographic Pun} : A homographic pun involves two words which are spelled the same but have different meanings.\\
           Example - \textit{I used to be a banker but I lost \textbf{interest}.}}
          \item {\textbf{Heterographic Pun} : A heterographic pun involves a word which sounds similar to another word which is spelled slightly differently.\\
          Example - \textit{Two construction workers had a \textbf{stairing} contest.}}
          \end{itemize}
          \\
        In our project, we have made use of extensive machine learning techniques to detect and locate a pun in a sentence. Along with that, we are also able to find out that if there is a pun, whether it is homographic or heterographic.\\}
      \end{block}
      \vskip2ex
      ...
      \begin{block}{Motivation}
       {\large \begin{itemize}
           \item Puns can be found almost everywhere, from things like advertising and marketing to literature and conversation.
