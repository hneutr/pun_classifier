...
\begin{itemize}
	...
	\item{\textbf{Visual}: A pun realized by an image. See figure \ref{fig:visual_pun}.
		\begin{figure}
		\centering
		\includegraphics[width=5cm]{figures/visual_pun.jpg}
		\caption{A visual Pun. }
		\small\caption{\url{https://digitalsynopsis.com/design/punny-pixels-illustrated-puns-visual-wordplay/}}\label{fig:visual_pun}
		\end{figure}
	}
\end{itemize}
